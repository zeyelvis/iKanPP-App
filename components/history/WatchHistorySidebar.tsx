  ...
  return (
    <>
      ...
      <aside
        ...
        className={`fixed top-0 right-0 bottom-0 w-[88%] sm:w-[90%] max-w-[420px] z-[2000] bg-[#0A0A0F]/95 backdrop-blur-3xl border-l border-white/10 p-6 flex flex-col shadow-2xl transition-transform duration-250 ease-out`}
      >
