...
export function InPlayerEpisodesDrawer({
  ...
  return (
    ...
    >
      <div
        className="w-80 sm:w-96 h-full bg-black/90 backdrop-blur-2xl border-l border-white/10 shadow-2xl flex flex-col pointer-events-auto transform transition-transform duration-300 text-white"
