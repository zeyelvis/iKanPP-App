...
const GOLDEN_PRIORITY_MAP: Record<string, number> = {
    // === 第一梯队：全量 443 端口纯净切片与数百万海量热播大源（CORS 100% 开放，全网全球秒开首选） ===
    'juliang': 0,   // 巨量资源 (纯净2.0切片，全球Anycast极速，4K/短剧秒播，全站No.1)
    'guangsu': 1,   // 光速资源 (全球高可用极速源，数百万海量新热影视，全站No.2)
    'baofeng': 2,   // 暴风资源 (国内多线CDN秒播骨干源，全站No.3)
